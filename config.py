...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7356131589:AAFIp9dye_cD1b_vnTeGl5UtKhuM-FYjPoU")
APP_ID = int(os.environ.get("APP_ID", "18799477")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "305cfa73e8b06daa97573809532034e5") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001874556147")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Theprotector01") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "5781922761")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://jloverpmc:OpyVDcmfekfH5oCm@cluster0.p7col.mongodb.net/?retryWrites=true&w=majority")
